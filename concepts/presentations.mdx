...
You create a presentation by uploading HTML through the [`uploadSharedPresentation`](/api-reference/upload-presentation) endpoint or by creating one in the dashboard.
...
You never deal with this path directly — Slideless serves the HTML through the [`getSharedPresentation`](/api-reference/get-shared-presentation) endpoint after token validation.
