...
description: "Pin a share token to a specific version or put it back on auto-follow-latest. Owner or active dev collaborator."
---
...
| `403` | `permission-denied` | Key lacks `presentations:write`, or not the owner / an active collaborator |
