...
Pull the notes reviewers left through an [annotator link](#slideless-share-presentationid) and merge them into your local **`.slideless/annotations.json`**. Owner-only.
