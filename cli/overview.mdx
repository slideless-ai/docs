...
<Note>
**Using Claude Desktop or claude.ai?** Skip the CLI install and use the [Slideless MCP server](/integrations/mcp-server) instead — sign in with your Slideless account, no terminal needed.
</Note>
