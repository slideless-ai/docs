...
<Note>
**Using Claude Desktop or claude.ai?** Skip the CLI install and use the [Slideless MCP connector](/integrations/claude-desktop-mcp) instead — sign in with your Slideless account, no terminal needed.
</Note>
