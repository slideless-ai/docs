...
Ask Claude: *"Publish my linked deck to the Slideless marketplace as a presentation."* Claude calls the `slideless_publish_listing` tool. See [MCP Server](/integrations/mcp-server).
