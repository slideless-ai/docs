...
Ask Claude: *"Search the Slideless marketplace for a pricing-calculator app and remix it."* Claude uses `slideless_search_marketplace`, `slideless_get_marketplace_listing`, and `slideless_remix_listing`. See [MCP Server](/integrations/mcp-server).
